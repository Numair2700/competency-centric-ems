    ...
    return (
        <>
            ...
            <EmsCard delay={1} className="overflow-hidden">
                ...
                <EmsTable
                    headers={['Student Number', 'Name', 'Email', 'Programme', 'Level', 'Units Graded']}
                ...
                >
                    {studentList.map((student) => (
                        <tr key={student.id} className="transition-colors hover:bg-white/50">
                            ...
                            <td className="px-6 py-4 text-sm text-ems-secondary/80">{student.programme}</td>
                            <td className="px-6 py-4 text-center">
                                <EmsPill>{student.level}</EmsPill>
                            </td>
